...
export default function useChartConfig({
  ...
  const [state, setState] = React.useState({
    ...
    snapCursor,
    datums,
    data: makeDataFrom(dataType, series, datums, useR, primaryStart, secondaryStart),
  });
...
function makeDataFrom(
  ...
  ].map((d, i) => makeSeries(i, dataType, datums, useR, primaryStart, secondaryStart ));
}
